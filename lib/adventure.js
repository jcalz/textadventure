...
(function (Adventure_1) {
        ...
        Adventure.prototype.newCommand = function (options) {
            ...
            if (typeof options.command == 'function') {
                ...
                commandFunction = function (object) {
                    ...
                    if (!object) {
                        tell(this, youCant_1.replace(/%[id][0-9]*/gi, '').replace(/\s+/g, ' '));
                        return;
                    }
                    if (!objectMethodName || !(objectMethodName in object)) {
                        tell(this, youCant_1.replace(/%[id][0-9]*/gi, objectName).replace(/\s+/g, ' '));
                        return;
                    }
    ...
    var Item = (function () {
        function Item(adventure, options, noEnforceImmutables) {
            ...
            if (defined(unwrappedId) && unwrappedId in itemMap)
    ...
    Person.newCommandClimb = {
        ...
        command: function (dir) {
            if (!dir) {
                var dir = (this.location && this.location.getExits().find(function (ex) {
    ...
    var Exit = (function (_super) {
        ...
        function Exit(adventure, options) {
            ...
            if (reverse !== false) {
                ...
                if (!dirName)
                    throw new Error('need direction for exit');
                ...
                if (defined(unwrappedRevId) && (unwrappedRevId in adventure.itemMap))
                    throw new Error('Cannot reuse id ' + unwrappedRevId +
                        ' for reverse.id');
        ...
        Exit.prototype.beUsedBy = function (subject) {
            ...
            tell(subject, void 0, function (witness) {
